...
public class UserController {
    ...
    @GetMapping(value = "/noteAnish", produces = "application/json")
    ...
    @PostMapping(value = "/noteAnish", produces = "application/json")
    ...
    @GetMapping(value = "/noteAnish/{id}", produces = "application/json")
    ...
    @PutMapping(value = "/noteAnish/{id}", produces = "application/json")
    ...
    @DeleteMapping(value = "/noteAnish/{id}", produces = "application/json")
    ...
    @GetMapping(value = "/noteAnish/{idNotes}/attachments", produces = "application/json")
    ...
    @PostMapping(value = "/noteAnish/{idNotes}/attachments", produces = "application/json")
    ...
    @PutMapping(value="/noteAnish/{idNotes}/attachments/{idAttachments}", produces="application/json")
    ...
    @DeleteMapping(value = "/noteAnish/{idNotes}/attachments/{idAttachments}", produces = "*/*")
